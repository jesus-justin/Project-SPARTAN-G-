    ...
    <div style={{ maxWidth: 1200, margin: '24px auto', padding: 16 }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
          ...
          <button onClick={() => navigate('/appointments')} style={{ padding: '8px 16px', background: '#ff6f00', color: '#fff', border: 'none', borderRadius: 4, cursor: 'pointer', fontWeight: 500 }}>
            📅 Appointments
          </button>
          <button onClick={() => navigate('/slots')} style={{ padding: '8px 16px', background: '#00796b', color: '#fff', border: 'none', borderRadius: 4, cursor: 'pointer', fontWeight: 500 }}>
            🕐 Slots
          </button>
          <button onClick={() => navigate('/emergency-contacts')} style={{ padding: '8px 16px', background: '#d32f2f', color: '#fff', border: 'none', borderRadius: 4, cursor: 'pointer', fontWeight: 500 }}>
            🆘 Contacts
          </button>
