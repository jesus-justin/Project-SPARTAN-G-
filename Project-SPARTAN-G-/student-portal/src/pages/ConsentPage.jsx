...
export default function ConsentPage() {
  ...
  return (
    <div className="page-frame consent-stack">
      <div
        style={{
      ...
      >
        <section style={cardStyle} className="consent-card">
        ...
        <section
          ...
          className="consent-card consent-highlight"
        >
        ...
        <section style={{ ...cardStyle, marginBottom: 0 }} className="consent-card">
